...
import { Eye, Images, ArrowLeft } from "lucide-react";
        ...
        >
          <div>
            ...
            <h2 className="text-3xl md:text-4xl text-primary mb-2">
              أحدث مشاريعنا المنفذة
            </h2>
            <p className="text-muted-foreground max-w-lg">
              اكتشف مجموعة مختارة من مشاريع التشطيبات السكنية والتجارية التي
              نفخر بتنفيذها
            </p>
          </div>
            ...
            >
              <Link to="/projects" className="block w-full h-full">
                ...
                <div className="absolute bottom-0 right-0 left-0 p-5 md:p-6">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-primary-foreground mt-2">
                    {project.title}
                  </h3>
                  <p className="text-primary-foreground/60 text-sm mt-1 line-clamp-1">
